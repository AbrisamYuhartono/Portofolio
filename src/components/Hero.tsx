...
const Hero: React.FC = () => {
  return (
<section className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-sky-200 via-white to-indigo-200 pt-64">
  ...
  <div className="w-48 h-72 rounded-full bg-gradient-to-br from-blue-600 to-teal-600 
    ...
    />
      ...
      >
        <ChevronDown className="h-8 w-8 text-gray-400 hover:text-blue-600 transition-colors" />
      </button>
    </section>
  );
};
